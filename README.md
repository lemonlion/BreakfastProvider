...
Tests generate **full flow diagrams** showing calls to the Service Under Test (SUT) and calls from the SUT to its dependencies. This provides clear sequence diagrams for all flows without manual maintenance. [Kronikol](https://github.com/lemonlion/Kronikol) is used for PlantUML diagram generation, embedded in the HTML specification report.
