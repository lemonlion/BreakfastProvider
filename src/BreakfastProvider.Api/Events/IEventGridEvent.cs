...
/// <summary>
/// AsyncAPI metadata for an Event Grid event, derived by convention from the event type.
/// </summary>
public record EventGridEventAsyncApiMetadata
{
...
public interface IEventGridEvent
{
    public string GetEventName() => GetType().Name.Replace("Event", "");
    public string GetVersion() => "1";

    static EventGridEventAsyncApiMetadata GetAsyncApiMetadata(Type eventType)
    {
        ...
        return new EventGridEventAsyncApiMetadata
        {
            ...
            OperationId = $"EventGrid{baseName}",
