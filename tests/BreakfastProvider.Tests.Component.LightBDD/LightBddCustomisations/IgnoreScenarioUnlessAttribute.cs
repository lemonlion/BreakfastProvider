...
public class IgnoreScenarioUnlessAttribute<T>(string settingName, params string[] reasons) : Attribute, IScenarioDecoratorAttribute where T : class
{
    public Task ExecuteAsync(IScenario scenario, Func<Task> scenarioInvocation)
    {
        ...
        var shouldIgnore = settingObjectValue is not true;
