...
namespace BreakfastProvider.Tests.Component.NUnit.Infrastructure;
...
public abstract class BaseFixture : DiagrammedComponentTest, IDisposable
{
    ...
    protected BaseFixture(bool delayAppCreation = false)
    {
        ...
        services.AddTransient<PostIngredientWasteSteps>();
        services.AddTransient<GetIngredientWasteSteps>();
        services.AddTransient<DeleteIngredientWasteSteps>();
        services.AddTransient<PostChefNoteSteps>();
        services.AddTransient<GetChefNoteSteps>();
