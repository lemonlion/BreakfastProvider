...
namespace BreakfastProvider.Tests.Component.NUnit.Scenarios.DailySpecials;

public class DailySpecials_Validation_Tests : BaseFixture
{
    [TestCase("SpecialId", null, "Special ID is required", "'Special Id' is required.", "Bad Request")]
    [TestCase("Quantity", "0", "Quantity must be greater than zero", "Quantity must be greater than zero.", "Bad Request")]
