...
public class Orders_Status_Transition_Tests : BaseFixture
{
    ...
    [TestCase("Created", "Preparing")]
    [TestCase("Created", "Cancelled")]
    [TestCase("Preparing", "Ready")]
    [TestCase("Ready", "Completed")]
    ...
    [TestCase("Created", "Ready")]
    [TestCase("Created", "Completed")]
    [TestCase("Preparing", "Cancelled")]
    [TestCase("Ready", "Preparing")]
    [TestCase("Completed", "Preparing")]
    [TestCase("Cancelled", "Preparing")]
    [TestCase("Cancelled", "Ready")]
