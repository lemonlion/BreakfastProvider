...
namespace BreakfastProvider.Tests.Component.NUnit.Scenarios.Pancakes;
...
public class Pancakes_Creation_Tests : BaseFixture
{
    ...
    [TestCase("Milk", "<script>alert</script>", "XSS in milk", "Milk contains potentially dangerous content.", "Bad Request")]
    [TestCase("Flour", "<img onerror=x>", "XSS in flour", "Flour contains potentially dangerous content.", "Bad Request")]
    [TestCase("Eggs", "javascript:void(0)", "XSS in eggs", "Eggs contains potentially dangerous content.", "Bad Request")]
