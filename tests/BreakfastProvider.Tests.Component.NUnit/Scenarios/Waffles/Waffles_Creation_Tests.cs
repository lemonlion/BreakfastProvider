...
namespace BreakfastProvider.Tests.Component.NUnit.Scenarios.Waffles;
...
public class Waffles_Creation_Tests : BaseFixture
{
    ...
    [TestCase("Butter", "", "Butter is required", "'Butter' is required.", "Bad Request")]
    [TestCase("Milk", "<script>alert</script>", "XSS in milk", "Milk contains potentially dangerous content.", "Bad Request")]
    [TestCase("Butter", "<img onerror=x>", "XSS in butter", "Butter contains potentially dangerous content.", "Bad Request")]
