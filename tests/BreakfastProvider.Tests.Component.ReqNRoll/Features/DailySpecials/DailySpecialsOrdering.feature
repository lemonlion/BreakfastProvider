Feature: Daily Specials Ordering
    ...
    Rule: Valid daily special orders are fulfilled
    ...
    Rule: Orders are rejected when the daily limit is reached
    ...
    Rule: Remaining quantity decreases with each order
