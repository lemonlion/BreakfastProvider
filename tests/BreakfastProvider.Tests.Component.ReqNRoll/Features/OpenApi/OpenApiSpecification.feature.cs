...
namespace BreakfastProvider.Tests.Component.ReqNRoll.Features.OpenApi
{
    ...
    public partial class OpenAPISpecificationFeature : object, Xunit.IClassFixture<OpenAPISpecificationFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/OpenApi", "OpenAPI Specification", "    /swagger/v1/swagger.json - Serving the OpenAPI specification describing all R" +
                "EST endpoints", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
        
#line 1 "OpenApiSpecification.feature"
#line hidden
        
        public OpenAPISpecificationFeature(OpenAPISpecificationFeature.FixtureData fixtureData, Xunit.ITestOutputHelper testOutputHelper)
        {
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/OpenApi/OpenApiSpecification.feature.ndjson", 3);
        }
        ...
        [global::Xunit.TraitAttribute("FeatureTitle", "OpenAPI Specification")]
...
#line hidden
        ...
        public class FixtureData : object, Xunit.IAsyncLifetime
        {
            ...
            async System.Threading.Tasks.ValueTask Xunit.IAsyncLifetime.InitializeAsync()
            {
                await OpenAPISpecificationFeature.FeatureSetupAsync();
            }
            
            async System.Threading.Tasks.ValueTask System.IAsyncDisposable.DisposeAsync()
            {
                await OpenAPISpecificationFeature.FeatureTearDownAsync();
            }
        }
    }
}
