Feature: Breakfast Order
    ...
    Rule: Creating an order publishes events and notifies the kitchen
    ...
    Rule: Creating an order produces audit and recipe logs
    ...
    Rule: Creating an order writes an outbox message for reliable delivery
