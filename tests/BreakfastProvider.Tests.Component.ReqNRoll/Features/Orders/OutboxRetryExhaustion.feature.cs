...
namespace BreakfastProvider.Tests.Component.ReqNRoll.Features.Orders
{
    ...
    public partial class OutboxRetryExhaustionFeature : object, Xunit.IClassFixture<OutboxRetryExhaustionFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Orders", "Outbox Retry Exhaustion", "    /orders - Outbox message transitions to failed after exhausting retries", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
        
#line 1 "OutboxRetryExhaustion.feature"
#line hidden
        
        public OutboxRetryExhaustionFeature(OutboxRetryExhaustionFeature.FixtureData fixtureData, Xunit.ITestOutputHelper testOutputHelper)
        {
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/Orders/OutboxRetryExhaustion.feature.ndjson", 3);
        }
        ...
        [global::Xunit.FactAttribute(DisplayName="An outbox message should transition to failed after exhausting retries")]
...
#line hidden
        ...
        public class FixtureData : object, Xunit.IAsyncLifetime
        {
            ...
            async System.Threading.Tasks.ValueTask Xunit.IAsyncLifetime.InitializeAsync()
            {
                await OutboxRetryExhaustionFeature.FeatureSetupAsync();
            }
            
            async System.Threading.Tasks.ValueTask System.IAsyncDisposable.DisposeAsync()
            {
                await OutboxRetryExhaustionFeature.FeatureTearDownAsync();
            }
        }
    }
}
