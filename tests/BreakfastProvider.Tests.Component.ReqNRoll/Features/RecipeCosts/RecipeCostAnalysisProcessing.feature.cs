...
using Reqnroll;
namespace BreakfastProvider.Tests.Component.ReqNRoll.Features.RecipeCosts
{
    
    
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Reqnroll", "3.0.0.0")]
    [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
    public partial class RecipeCostAnalysisProcessingFeature : object, Xunit.IClassFixture<RecipeCostAnalysisProcessingFeature.FixtureData>, Xunit.IAsyncLifetime
    {
...
#line hidden
        ...
        public RecipeCostAnalysisProcessingFeature(RecipeCostAnalysisProcessingFeature.FixtureData fixtureData, Xunit.ITestOutputHelper testOutputHelper)
        {
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/RecipeCosts/RecipeCostAnalysisProcessing.feature.ndjson", 3);
        }
...
#line hidden
        ...
        public class FixtureData : object, Xunit.IAsyncLifetime
        {
            ...
            async System.Threading.Tasks.ValueTask Xunit.IAsyncLifetime.InitializeAsync()
            {
                await RecipeCostAnalysisProcessingFeature.FeatureSetupAsync();
            }
            
            async System.Threading.Tasks.ValueTask System.IAsyncDisposable.DisposeAsync()
            {
                await RecipeCostAnalysisProcessingFeature.FeatureTearDownAsync();
            }
        }
    }
}
