...
public class DependencyInjectionSetup
{
    ...
    public static IServiceCollection CreateServices()
    {
        ...
        services.AddScoped<PostIngredientWasteSteps>();
        services.AddScoped<GetIngredientWasteSteps>();
        services.AddScoped<DeleteIngredientWasteSteps>();
        services.AddScoped<PostChefNoteSteps>();
        services.AddScoped<GetChefNoteSteps>();
