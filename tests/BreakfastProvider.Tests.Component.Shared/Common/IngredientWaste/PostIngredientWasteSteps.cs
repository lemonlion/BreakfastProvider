...
public class PostIngredientWasteSteps(RequestContext context)
{
    public TestIngredientWasteRequest Request { get; set; } = new();
    public HttpResponseMessage? ResponseMessage { get; private set; }
    public TestIngredientWasteResponse? Response { get; private set; }

    public async Task Send()
    {
        var request = new HttpRequestMessage(HttpMethod.Post, Endpoints.IngredientWaste)
        {
    ...
    public async Task ParseResponse()
    {
        ...
        Response = Json.Deserialize<TestIngredientWasteResponse>(content)!;
    }
}
