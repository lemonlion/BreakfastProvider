...
namespace BreakfastProvider.Tests.Component.Shared.Common.Validation;

public static class ValidationHelper
{
    public static List<T> CreateValidationRequests<T>(T validBase, IEnumerable<InvalidFieldFromRequest> inputs)
        where T : class
    {
