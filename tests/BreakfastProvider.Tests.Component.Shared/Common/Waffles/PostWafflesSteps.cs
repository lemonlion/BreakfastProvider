...
namespace BreakfastProvider.Tests.Component.Shared.Common.Waffles;

public class PostWafflesSteps(RequestContext context)
{
    public TestWaffleRequest Request { get; set; } = new();
    public HttpResponseMessage? ResponseMessage { get; private set; }
    public TestWaffleResponse? Response { get; private set; }
