...
public static class IgnoreReasons
{
    ...
    public const string NeedsInMemoryEventConsumer = "This test publishes directly to in-memory event stores which are not available in post-deployment environments";
