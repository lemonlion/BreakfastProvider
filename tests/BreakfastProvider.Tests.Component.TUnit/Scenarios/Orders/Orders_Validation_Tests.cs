...
public class Orders_Validation_Tests : BaseFixture
{
    ...
    [Test]
    [Arguments("CustomerName", "", "Customer name is required", "'Customer Name' is required.", "Bad Request")]
    [Arguments("Items", null, "At least one item is required", "The Items field is required.", "Bad Request")]
    [Arguments("Items[0].ItemType", "", "Item type is required", "'Item Type' is required.", "Bad Request")]
    [Arguments("Items[0].BatchId", null, "Batch ID is required", "'Batch Id' is required.", "Bad Request")]
    [Arguments("Items[0].Quantity", "0", "Quantity must be greater than zero", "Quantity must be greater than zero.", "Bad Request")]
    ...
    [Test]
    [Arguments("Status", "", "Status is required", "'Status' is required.", "Bad Request")]
