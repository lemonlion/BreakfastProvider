...
{
    [Test]
    [Arguments("Name", "<script>alert('xss')</script>", "Script tag in name", "Name contains potentially dangerous content.", "Bad Request")]
    [Arguments("Name", "<img src=x onerror=alert(1)>", "Event handler in name", "Name contains potentially dangerous content.", "Bad Request")]
    [Arguments("Category", "<script>alert('xss')</script>", "Script tag in category", "Category contains potentially dangerous content.", "Bad Request")]
    [Arguments("Category", "javascript:alert(1)", "Javascript protocol", "Category contains potentially dangerous content.", "Bad Request")]
    [Arguments("Name", "", "Name is required", "'Name' is required.", "Bad Request")]
    [Arguments("Category", "", "Category is required", "'Category' is required.", "Bad Request")]
